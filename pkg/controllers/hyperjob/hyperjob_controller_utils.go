...
// Conditions list
const (
	// HyperJobConditionCompleted indicates whether all child VCJobs have reached terminal state
	HyperJobConditionCompleted = "Completed"
)

// Reasons list
const (
	// HyperJobReasonCompleted indicates that all child VCJobs have reached terminal state
	HyperJobReasonCompleted = "AllChildVCJobsCompleted"
	// HyperJobReasonIsInProgress indicates that some child VCJobs are still in progress (e.g. Running or Pending)
	HyperJobReasonIsInProgress = "ChildVCJobsInProgress"
)
